...
export interface Character {
  ...
  folderName?: string
  /** Active status icon emoji for rendering above character */
  activityIcon: string | null
  /** Timer for how long to show the activity icon */
  activityTimer: number
  /** Chat text to display as floating text above character */
  chatText: string | null
  /** Timer for chat text display */
  chatTextTimer: number
  /** Agent's current mood: happy, focused, stressed, praying */
  mood: 'happy' | 'focused' | 'stressed' | 'praying' | 'idle'
  /** Is currently looking up (investor effect) */
  lookingUp: boolean
  /** Timer for looking up effect */
  lookUpTimer: number
}
